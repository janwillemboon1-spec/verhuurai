          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-y-0">
            ...
            <div className="card p-8 relative
              ...
              <div className="border-t border-border pt-4 space-y-3">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <Link href="/gratis" className="btn-secondary text-[11px] text-center flex items-center justify-center py-2.5">Gratis proberen</Link>
                  <Link href="/listing-optimizer" className="btn-primary text-[11px] text-center flex items-center justify-center py-2.5">Meer info →</Link>
                </div>
            ...
            <div className="card p-8 relative border-accent/40
              ...
              <div className="border-t border-border pt-4 space-y-3">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <Link href="/host-performance/aanmelden?type=eenmalig" className="btn-primary text-[11px] text-center flex items-center justify-center py-2.5">Rapport aanvragen →</Link>
                  <Link href="/host-performance" className="btn-secondary text-[11px] text-center flex items-center justify-center py-2.5">Meer info →</Link>
                </div>
