...
- RULES block to append verbatim: "Enhancement philosophy: Achieve 5-star hotel photo quality through perfect brightness, sharpness, white balance, color accuracy, and clarity. Make the room feel bright, airy, and inviting — the way a professional hotel photographer would capture it. ALLOWED: smooth out wrinkled or creased pillows, cushions, and bedding to look crisp and hotel-quality — a photographer would always do this before shooting. NEVER add furniture, objects, or decorations. NEVER change the room layout or composition. NEVER invent views or scenery outside windows. NEVER hide damage, stains, or structural issues. The enhanced photo must represent the exact same space — same furniture, same condition, same room — just captured at its absolute best. Photorealistic result, not CGI."`,
          },
        ],
      },
    ],
