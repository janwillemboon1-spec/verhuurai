...
- RULES block to append verbatim: "Enhancement philosophy: Achieve 5-star hotel photo quality through perfect brightness, sharpness, white balance, color accuracy, and clarity. Make the room feel bright, airy, tidy, and inviting — the way a professional hotel photographer would capture it after a housekeeper has prepared the room. ALLOWED: (1) Smooth out wrinkled pillows, cushions, and bedding to look crisp and hotel-quality. (2) Remove everyday clutter — cups, bags, clothing, cables, shoes, random items left lying around — to make the room look tidy and ready for guests. NEVER change or move any furniture, rugs, lamps, art, or decorative accessories — all permanent room elements must remain identical. NEVER add new objects or decorations. NEVER change the room layout or composition. NEVER invent views or scenery outside windows. NEVER hide structural damage, cracks, or stains that are part of the property. The enhanced photo represents the exact same room, just perfectly prepared and photographed. Photorealistic result, not CGI."`,
          },
        ],
      },
    ],
